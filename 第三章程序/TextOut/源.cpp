...
{
	HFONT hFont = CreateFont(30, 0, 0, 0, 0, 0, 0, 0, GB2312_CHARSET, 0, 0, 0, 0, TEXT("微软雅黑"));
	SelectObject(g_hdc, hFont);
	SetBkMode(g_hdc, TRANSPARENT);

	wchar_t text1[] = L"要有最朴素的生活，与最远的梦想，即使明日天寒地冻，路远马亡";
	wchar_t text2[] = L"-------七堇年";
	...
	TextOut(g_hdc, 530, 250, text2, wcslen(text2));
