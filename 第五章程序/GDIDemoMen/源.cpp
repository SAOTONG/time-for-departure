...
HBITMAP g_hMan1 = NULL, g_hMan2 = NULL;
//---------------------------------------------------------------------------
// 描述：全局函数声明
//---------------------------------------------------------------------------
...
BOOL Game_Init(HWND hWnd)
{
	...
	g_hMan1 = (HBITMAP)LoadImage(NULL, L"character1.bmp", IMAGE_BITMAP, 640, 579, LR_LOADFROMFILE);
	g_hMan2 = (HBITMAP)LoadImage(NULL, L"character2.bmp", IMAGE_BITMAP, 800, 584, LR_LOADFROMFILE);	
...
VOID Game_Paint(HWND hWnd)
{
	...
	SelectObject(g_mdc, g_hMan1);
	BitBlt(g_hdc, 50, WINDOW_HEIGHT - 579, 320, 579, g_mdc, 320, 0, SRCAND);
	BitBlt(g_hdc, 50, WINDOW_HEIGHT - 579, 320, 579, g_mdc, 0, 0, SRCPAINT);

	SelectObject(g_mdc, g_hMan2);
...
BOOL Game_CleanUp(HWND hWnd)
{
	...
	DeleteObject(g_hMan1);
	DeleteObject(g_hMan2);
	DeleteDC(g_mdc);
	return true;
}
